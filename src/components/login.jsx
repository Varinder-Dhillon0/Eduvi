...
export default function Login({Loginstate,setLoginstate}) {
    ...
    const validateSignup = () => {
      ...
      const handleSignup = async () => {
        ...
        const sendUser = axios.post("https://eduvi.up.railway.app/SignUp", {
  ...
  function handleLogin(){
    ...
    const login = axios.post("https://eduvi.up.railway.app/signin", {
      email : email,
      password : password
    }).then((res) =>{
      if(res.data.token){
    ...
    return (
        <div className="login-wrap">
            ...
            <div className="login">
                ...
                <svg width="1" height="523" viewBox="0 0 1 641" fill="none" xmlns="https://www.w3.org/2000/svg">
                ...
                <div className="login-form">
                    ...
                    <h2>Email</h2>
                    <div className="input">
                        <svg width="15" height="20" viewBox="0 0 16 12" fill="none" xmlns="https://www.w3.org/2000/svg">
